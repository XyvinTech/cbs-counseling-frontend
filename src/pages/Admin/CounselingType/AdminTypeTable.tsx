...
const AdminTypeTable: React.FC<TypeTableProps> = ({ searchValue }) => {
              ...
              packageData.map((packageItem, key) => (
                <tr key={key}>
                  ...
                  <td className="border-b border-[#eee] py-5 px-4 dark:border-strokedark">
                    <p className="text-black dark:text-white">
                      {moment(packageItem?.createdAt).format("MMMM DD, YYYY")}
                    </p>
                  </td>
          ...
          <div className="fixed inset-0 flex items-center justify-center bg-gray-800 bg-opacity-50">
            <div className="bg-white rounded-lg shadow-lg w-96 p-6 dark:bg-graydark">
              ...
              <p className="mt-4 text-gray-600">
                Are you sure you want to delete this Counseling Type? This
